...
while points != 99999999999999: 
    ...
    if move == "ROCK" and comp_move == "ROCK":          # T
        ...
        ties = ties + 1
        print("Tie") 
    elif move != "SCISSORS" and move != "ROCK" and move != "PAPER" and move != "SETTINGS" and move != "STATS" and move != "STORE" and move != "DEV" and move != "SIMULATE" and move != "USER" and move != "SIM" and move != "HELP":
